<section class="development-img">
    <h3 class="textP">Conoce nuestros Desarrollos Urbanisticos</h3>
...
<section class="vision-sect">
    ...
    <article class="dev-img-cont">
        ...
        <div class="image-dev-over-cont">
        <img class="dev-img-bord" src="<?php echo base_url('public/assets/images/Villa.jpg');?>" alt="villa magdalena">
                <div class="over-see">
                  <div class="see-dev">Ver Desarrollo</div>
                </div>
        </div>
