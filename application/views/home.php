                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="<?php echo base_url('public/assets/images/sierras.jpg');?>"
                                class="d-block w-100 carrousel-img" alt="Inmobiliaria-terrazas">
                        </div>
                        <div class="carousel-item">
                            <img src="<?php echo base_url('public/assets/images/Hospital.jpeg');?>"
                                class="d-block w-100 carrousel-img" alt="Inmobiliaria-terrazas">
                        </div>
                    </div>
                        ...
                        <div class="search-cont">
                            ...
                            <div class="search-input-cont">
                                <input type="text" name="search" id="search"
                                    placeholder="Busca por localidad, barrio o zona" class="search-input">
                            </div>
            ...
            <section class="section-space gray-color">
                ...
                <div class="home-cards-container">
                    ...
                    <div class="card">
                        ...
                        <div id="<?php echo "card".$i?>" class="carousel slide" data-bs-ride="false">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo base_url('public/assets/images/San_Luis1.jpg');?>"
                            ...
                            <button class="carousel-control-prev" type="button" data-bs-target="<?php echo "#card".$i?>"
                                data-bs-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="visually-hidden">Previous</span>
                            </button>
                            <button class="carousel-control-next" type="button" data-bs-target="<?php echo "#card".$i?>"
                                data-bs-slide="next">
            ...
            <section class="service-section">
                ...
                <div class="item-serv-cont">
                    <svg width="70" height="70" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M43.7397 14.3751C43.705 14.025 43.5821 13.6894 43.3825 13.3997C43.1828 13.1101 42.9129 12.8758 42.598 12.7189L25.9313 4.38553C25.6419 4.24069 25.3227 4.16528 24.999 4.16528C24.6754 4.16528 24.3562 4.24069 24.0667 4.38553L7.40008 12.7189C7.08607 12.8767 6.81699 13.1112 6.61777 13.4008C6.41856 13.6903 6.29567 14.0254 6.2605 14.3751C6.23758 14.598 4.25842 36.8064 24.1542 45.6543C24.4201 45.7742 24.7084 45.8363 25.0001 45.8363C25.2917 45.8363 25.5801 45.7742 25.8459 45.6543C45.7417 36.8064 43.7626 14.6001 43.7397 14.3751ZM25.0001 41.4522C10.898 34.6355 10.2313 20.0876 10.3459 15.9064L25.0001 8.57927L39.6438 15.9022C39.7209 20.0459 38.9605 34.6897 25.0001 41.4522Z"
                            fill="#D6AB55" />
                        <path
                            d="M22.9168 26.2209L18.1397 21.4438L15.1938 24.3896L22.9168 32.1125L34.8063 20.2229L31.8605 17.2771L22.9168 26.2209Z"
                            fill="#D6AB55" />
                    </svg>
            ...
            <section class="section-space">
                ...
                <div class="development-card">
                    <img class="dev-img" src="<?php echo base_url('public/assets/images/altosdelCerro.jpg');?>"
                        alt="altos del cerro">
                    <div class="dev-info">
                        <p class="dev-description general-text">A solo 5 minutos de la ciudad con agil acceso por
                            autopistas y vista panoramica a las sierras.
                            Actualmente este desarrollo de 35 lotes se a convertido en una avanzanda zona residencial y
                            foco urbanistico.</p>
                        <button class="btn-dw button-center margin-dev-btn">Ver Mas</button>
                    </div>
                </div>
                <div class="development-card reverse">
                    <img class="dev-img-reverse" src="<?php echo base_url('public/assets/images/Villa.jpg');?>"
                        alt="villa magdalena">
            ...
            <section class="section-space gray-color">
                ...
                <div class="contact-container">
                    ...
                    <div class="contact-info">
                        <div>
                            <h4 class="general-text"><i class="bi bi-geo-alt gold-color icon-contact"> </i>Ubicacion:
                            </h4>
                            <p>9 de Julio 748<br> San Luis - Argentina</p>
                        </div>
                        <div>
                            <h4 class="general-text"><i class="bi bi-clock gold-color icon-contact"> </i>Horiarios de
                                Atencion:</h4>
                            <p>Lunes a viernes: 9 a 17hs<br> Sabados: cerrado</p>
                        ...
                        <div>
                            <h4 class="general-text"><i class="bi bi-telephone gold-color icon-contact"> </i>Telefono:
                            </h4>
                            <p>0266-4422515</p>
                        </div>
                    </div>
